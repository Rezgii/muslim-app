...
List<ThikerModel> morning = [
  ...
  ThikerModel(
    thiker:
        "اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْكُفْرِ، وَالفَقْرِ، وَأَعُوذُ بِكَ مِنْ عَذَابِ القَبْرِ، لاَ إِلَهَ إِلاَّ أَنْتَ.",
    repeat: 3,
  ),
  ThikerModel(
    thiker:
  ...
  ThikerModel(
    thiker:
        "رَضِيتُ بِاللَّهِ رَبّاً، وَبِالْإِسْلَامِ دِيناً، وَبِمُحَمَّدٍ صَلَّى اللَّهُ عَلَيهِ وَسَلَّمَ نَبِيّاً.",
    repeat: 3,
  ),
  ThikerModel(
    thiker:
  ...
  ThikerModel(
    thiker:
        "أَصْبَحْنَا عَلَى فِطْرَةِ الإِسْلاَمِ وَ عَلَى كَلِمَةِ الإِخْلاَصِ، وَعَلَى دِينِ نَبِيِّنَا مُحَمَّدٍ صَلَّى اللَّهُ عَلَيهِ وَسَلَّمَ، وَعَلَى مِلَّةِ أَبِينَا إِبْرَاهِيمَ حَنِيفَاً مُسْلِماً وَمَا كَانَ مِنَ الْمُشْرِكِينَ.",
    repeat: 1,
  ),
  ThikerModel(thiker: "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ.", repeat: 100),
  ThikerModel(
    thiker:
  ...
  ThikerModel(thiker: "أَسْتَغْفِرُ اللَّهَ وَأَتُوبُ إِلَيْهِ.", repeat: 100),
  ThikerModel(
    thiker: "اللَّهُمَّ صَلِّ وَسَلِّمْ وَبَارِكْ عَلَى نَبَيِّنَا مُحَمَّدٍ.",
    repeat: 10,
  ),
];
...
List<ThikerModel> evening = [
  ...
  ThikerModel(
    thiker:
        "أَمْسَيْنَا وَأَمْسَى المُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ لا إلَهَ إلَّا اللَّهُ، وَحْدَهُ لا شَرِيكَ له المُلْكُ وَلَهُ الحَمْدُ وَهو علَى كُلِّ شيءٍ قَدِيرٌ، رَبِّ أَسْأَلُكَ خَيْرَ ما في هذِه اللَّيْلَةِ وَخَيْرَ ما بَعْدَهَا، وَأَعُوذُ بكَ مِن شَرِّ ما في هذِه اللَّيْلَةِ وَشَرِّ ما بَعْدَهَا، رَبِّ أَعُوذُ بكَ مِنَ الكَسَلِ وَسُوءِ الكِبَرِ، رَبِّ أَعُوذُ بكَ مِن عَذَابٍ في النَّارِ وَعَذَابٍ في القَبْرِ.",
    repeat: 1,
  ),
  ThikerModel(
    thiker:
  ...
  ThikerModel(
    thiker:
        "أَمْسَيْنَا وأمْسَى الْمُلْكُ لِلَّهِ رَبِّ الْعَالَمِينَ، اللَّهُـمَّ إِنِّي أَسْأَلُكَ خَيْرَ هَذِهِ اللّيْلَةِ فَتْحَهَا، وَنَصْرَهَا، وَنورَهَا، وَبَرَكَتَهَا، وَهُدَاهَا، وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِيهَا وَشَرِّ مَا بَعْدَهَا.",
    repeat: 1,
  ),
  ThikerModel(
    thiker:
        "أَمْسَيْنَا عَلَى فِطْرَةِ الإِسْلاَمِ وَ عَلَى كَلِمَةِ الإِخْلاَصِ، وَعَلَى دِينِ نَبِيِّنَا مُحَمَّدٍ صَلَّى اللَّهُ عَلَيهِ وَسَلَّمَ، وَعَلَى مِلَّةِ أَبِينَا إِبْرَاهِيمَ حَنِيفَاً مُسْلِماً وَمَا كَانَ مِنَ الْمُشْرِكِينَ.",
    repeat: 1,
  ),
  ThikerModel(thiker: "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ.", repeat: 100),
  ThikerModel(
  ...
  ThikerModel(
    thiker: "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ.",
    repeat: 3,
  ),
  ThikerModel(
    thiker: "اللَّهُمَّ صَلِّ وَسَلِّمْ عَلَى نَبَيِّنَا مُحَمَّدٍ.",
    repeat: 10,
  ),
];

List<ThikerModel> wakeup = [
  ThikerModel(
    thiker:
...
List<ThikerModel> sleep = [
  ...
  ThikerModel(
    thiker: "اللَّهُمَّ قِنِي عَذَابَكَ يَوْمَ تَبْعَثُ عِبَادَكَ.",
    repeat: 3,
  ),
  ThikerModel(thiker: "بِاسْمِكَ اللَّهُمَّ أَمُوتُ وَأَحْيَا.", repeat: 1),
  ThikerModel(thiker: "سُبْحَانَ اللَّهِ.", repeat: 33),
  ThikerModel(thiker: "الْحَمْدُ لِلَّهِ.", repeat: 33),
  ThikerModel(thiker: "اللَّهُ أَكْبَرُ.", repeat: 34),
  ThikerModel(
    thiker:
...
List<ThikerModel> praying = [
  ...
  ThikerModel(
    thiker: "سُـبْحانَ اللهِ، والحَمْـدُ لله ، واللهُ أكْـبَر.",
    repeat: 33,
  ),
  ThikerModel(
    thiker:
  ...
  ThikerModel(
    thiker:
        "بَعْدَ صَلاةِ الْمَغْرِبِ وَالصُّبْحِ : (( لاَ إِلَهَ إِلاَّ اللَّهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ يُحْيِي وَيُمِيتُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ )).",
    repeat: 10,
  ),
  ThikerModel(
    thiker:
        "بَعْدَ صَلاةِ الفَجْرِ : (( اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْماً نافِعاً، وَرِزْقاً طَيِّباً، وَعَمَلاً مُتَقَبَّلاً )).",
    repeat: 1,
  ),
];
